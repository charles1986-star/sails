...
export default function ShopCategoryCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(`${API_URL}/admin/shop-categories`, payload, { headers: getAuthHeader() });
      setNotice({ message: "Category created successfully!", type: "success" });
      setTimeout(() => navigate("/admin/shop-categories"), 1500);
    } catch (err) {
      setNotice({ message: err.response?.data?.msg || "Failed to create category", type: "error" });
    }
    setLoading(false);
  };
